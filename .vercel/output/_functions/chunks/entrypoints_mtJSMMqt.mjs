import { A as REDIRECT_STATUS_CODES, At as MissingLocale, B as collapseDuplicateSlashes, Bt as RewriteWithBodyUsed, D as ASTRO_ERROR_HEADER, Dt as MiddlewareNotAResponse, E as isRoute500, Et as MiddlewareNoDataOrNextCalled, F as originPathnameSymbol, Ft as PrerenderClientAddressNotAvailable, H as fileExtension, Ht as SessionStorageSaveError, I as pipelineSymbol, It as PrerenderDynamicEndpointPathCollide, J as removeLeadingForwardSlash, Jt as AstroError, K as joinPaths, L as responseSentSymbol$1, M as appSymbol, N as clientAddressSymbol, Nt as NoMatchingStaticPathFound, O as ASTRO_GENERATOR, P as fetchStateSymbol, Pt as PageNumberParamNotFound, Q as trimSlashes, R as appendForwardSlash, Rt as ReservedSlotName, S as renderEndpoint, T as isRoute404, Tt as LocalsReassigned, U as hasFileExtension, Ut as StaticClientAddressNotAvailable, V as collapseDuplicateTrailingSlashes, Vt as SessionStorageInitError, W as isInternalPath, Wt as UnableToLoadLogger, X as removeTrailingForwardSlash, Z as slash, a as renderComponent, at as ClientAddressNotAvailable, b as isAstroComponentFactory, bt as InvalidGetStaticPathsReturn, d as renderTemplate, et as matchPattern, f as decodeKey, ft as ForbiddenRewrite, ht as GetStaticPathsRequired, i as renderJSX, it as CacheNotEnabled, j as REROUTABLE_STATUS_CODES, k as DEFAULT_404_COMPONENT, l as renderSlotToString, m as generateCspDigest, mt as GetStaticPathsInvalidRouteParam, nt as ActionsReturnedInvalidDataError, o as chunkToString, p as decryptString, pt as GetStaticPathsExpectedParams, q as prependForwardSlash, qt as i18nNoLocaleFoundInPath, r as renderPage, rt as AstroResponseHeadersReassigned, s as createSlotValueFromString, tt as ActionNotFoundError, u as isRenderTemplateResult, wt as LocalsNotAnObject, y as isRenderInstruction, yt as InvalidGetStaticPathsEntry, z as collapseDuplicateLeadingSlashes, zt as ResponseSentError } from "./server_DqMh0nkK.mjs";
...
//#endregion
export { App as a, getLocaleRelativeUrl as c, redirectToFallback as d, requestHasLocale as f, toRoutingStrategy as i, notFound as l, defineMiddleware as m, deserializeRouteInfo as n, DefaultFetchHandler as o, sequence as p, toFallbackType as r, createMiddleware as s, deserializeManifest as t, redirectToDefaultLocale as u };
